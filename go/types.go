...
// Request contains the parameters for the Chess Move Validator API.
//
// Parameters:
//   - move (required): string - Chess move in algebraic notation
type Request struct {
	Move string `json:"move"` // Required
}
...
// ResponseData contains the data returned by the Chess Move Validator API.
