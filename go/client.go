// Package chessmovevalidator provides a Go client for the Chess Move Validator API.
//
// For more information, visit: https://apiverve.com/marketplace/chessmovevalidator?utm_source=go&utm_medium=readme
package chessmovevalidator
...
const (
	baseURL        = "https://api.apiverve.com/v1/chessmovevalidator"
	defaultTimeout = 30 * time.Second
)

// Client is the Chess Move Validator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Chess Move Validator API client.
...
// Execute makes a request to the Chess Move Validator API with typed parameters.
//
...
//   - move (required): string - Chess move in algebraic notation
