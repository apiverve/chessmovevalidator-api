...
namespace APIVerve.API.ChessMoveValidator
{
    ...
    /// <summary>
    /// Client for the ChessMoveValidator API
    /// </summary>
    public class ChessMoveValidatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/chessmovevalidator";
        ...
        {
            { "move", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public ChessMoveValidatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ChessMoveValidatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ChessMoveValidatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ChessMoveValidatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ChessMoveValidatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(ChessMoveValidatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ChessMoveValidatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ChessMoveValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ChessMoveValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ChessMoveValidatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ChessMoveValidatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ChessMoveValidatorQueryOptions options)
        {
