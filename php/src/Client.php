...
namespace APIVerve\Chessmovevalidator;
...
/**
 * Client for the Chess Move Validator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/chessmovevalidator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/chessmovevalidator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ChessmovevalidatorClient] {$message}\n";
        }
    }
}
