# Chess Move Validator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:chessmovevalidator-api:1.1.13'
}
```
...
```java
import com.apiverve.chessmovevalidator.ChessMoveValidatorAPIClient;
import com.apiverve.chessmovevalidator.APIResponse;
import com.apiverve.chessmovevalidator.APIException;

// Initialize the client
ChessMoveValidatorAPIClient client = new ChessMoveValidatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("move", "Nf3");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/chessmovevalidator](https://docs.apiverve.com/ref/chessmovevalidator)
...
- **Documentation:** [https://docs.apiverve.com/ref/chessmovevalidator](https://docs.apiverve.com/ref/chessmovevalidator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/chessmovevalidator-api/issues)
